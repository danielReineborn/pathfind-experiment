...
export default function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case "updateGrid":
      return { ...state, grid: action.updateGrid };
    ...
    case "eraseWall":
      return { ...state, eraseWall: action.eraseWall }

    case "wallPaint":
      console.log("WALL", action.wallPaint)
      return { ...state, wallPaint: action.wallPaint };

    case "mousePress":
      return { ...state, mousePress: action.mousePress };

    case "reset":
      return { ...state, grid: makeGrid(50, 20), start: 154, end: 160, wallPaint: false, mousePress: false }
